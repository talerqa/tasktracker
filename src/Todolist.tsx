...
export const Todolist = memo((props: PropsType) => {
    ...
    return <div>
        ...
        <div style={{paddingTop: '10px'}}>
            <ButtonWithMemo title={'All'} color={'inherit'} variant={props.filter === 'all' ? 'outlined' : 'text'}
                            onClick={onAllClickHandler}/>
            <ButtonWithMemo title={'Active'} color={'primary'} variant={props.filter === 'active' ? 'outlined' : 'text'}
